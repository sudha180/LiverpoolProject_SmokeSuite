...
RunConfiguration.setExecutionSettingFile('C:\\Users\\mahi1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Checkout\\TS_SMOKE_SUITE_082\\20230817_212131\\execution.properties')
...
not_run: WebUI.click(findTestObject('PLPPage/product1_PLP'), FailureHandling.OPTIONAL)

not_run: WebUI.click(findTestObject('PDPPage/AddToCart_PDP'))

not_run: WebUI.click(findTestObject('HomePage/bag_header_HP'))

not_run: WebUI.click(findTestObject('CartPage/BuyButton_Cart'))

//WebUI.callTestCase(findTestCase('CommonMethods/create_new_CARD_OPC'), [:], FailureHandling.STOP_ON_FAILURE)
not_run: WebUI.click(findTestObject('OPCPage/paymentMethod_change_OPC'))

not_run: WebUI.scrollToElement(findTestObject('OPCPage/card3_Option_OPC'), 0)

not_run: WebUI.delay(3)

not_run: WebUI.click(findTestObject('OPCPage/card3_Option_OPC'))

not_run: WebUI.delay(3)

not_run: WebUI.click(findTestObject('OPCPage/option2DropDown_editos_card_OPC'))
