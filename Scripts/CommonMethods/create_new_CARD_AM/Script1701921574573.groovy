...
String cardnumber = '41000000' + RandomStringUtils.randomNumeric(8)
...
WebUI.setText(findTestObject('OPCPage/cellphone_addAddress_opc'), GlobalVariable.CellPhoneAddAddress, FailureHandling.OPTIONAL)

WebUI.setText(findTestObject('OPCPage/LADA_addAddress_opc'), GlobalVariable.LADAaddAddress, FailureHandling.OPTIONAL)

WebUI.setText(findTestObject('OPCPage/phone_addAddress_opc'), GlobalVariable.phoneAddAddress, FailureHandling.OPTIONAL)
