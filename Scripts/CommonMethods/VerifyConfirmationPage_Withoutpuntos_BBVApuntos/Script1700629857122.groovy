...
WebUI.verifyElementText(findTestObject('ConfirmationPage/Pagaste_un_total_de_header_confirmPage'), 'Pagaste un total de:')
...
WebUI.verifyElementText(findTestObject('ConfirmationPage/Detalle_de_puntos_BBVA_confirmPage'), 'Detalle de puntos BBVA')
