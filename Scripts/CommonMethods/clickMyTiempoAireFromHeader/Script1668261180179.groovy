...
WebUI.verifyElementPresent(findTestObject('Object Repository/AccountManagement/div_1. Selecciona tus nmeros a recargar_tiempoAire_AM'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/AccountManagement/div_Home   Tiempo Aire Tiempo Aire1. Selecc_8a50a7'), 
    0)
