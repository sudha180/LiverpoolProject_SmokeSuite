...
WebUI.callTestCase(findTestCase('CommonMethods/create_new_CARD_AM'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementNotPresent(findTestObject('AccountManagement/ATT/MessageBelow_CheckBox_ATT'), 0)
