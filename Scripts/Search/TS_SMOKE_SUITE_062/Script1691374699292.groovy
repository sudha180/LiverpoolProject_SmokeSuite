...
WebUI.verifyElementPresent(findTestObject('PLPPage/product1_cardPrice_PLP'), 0)

WebUI.verifyElementPresent(findTestObject('PLPPage/product1_discountPrice_PLP'), 0)
