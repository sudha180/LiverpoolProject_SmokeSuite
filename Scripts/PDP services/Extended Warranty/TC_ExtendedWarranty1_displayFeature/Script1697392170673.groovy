...
WebUI.verifyElementPresent(findTestObject('PDPPage/ComplementaryServices_Div_noRequire_ExtendedWarranty_PDP'), 0)
...
WebUI.click(findTestObject('CartPage/CambiarGarantia_ChangeProtection1_cartPage'))
